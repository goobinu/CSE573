...
EXPECTED_SOURCES = ["LinkedIn", "Reddit", "TechCrunch", "Startups Gallery", "JobBoards", "Y Combinator"]
...
JOBBOARDS_CLEANED_CSV_PATH = os.path.join(DATA_DIR_PROCESSED, "jobboards_cleaned_for_extraction.csv")
