...
from config import CURATED_CATEGORIES_PATH, SUBPAGE_RESULTS_DIR

curated_categories = CURATED_CATEGORIES_PATH
...
def save_subpage_results(category, results):
    ...
    filepath = os.path.join(SUBPAGE_RESULTS_DIR, f"{filename}.csv")
